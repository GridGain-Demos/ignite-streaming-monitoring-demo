...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5379201317804970165L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Account\",\"namespace\":\"org.gridgain.demo.kafka\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Account Id\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Stock Name\"}],\"version\":\"1\"}");
   ...
   */
  public static org.gridgain.demo.kafka.model.Account.Builder newBuilder() {
    return new org.gridgain.demo.kafka.model.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static org.gridgain.demo.kafka.model.Account.Builder newBuilder(org.gridgain.demo.kafka.model.Account.Builder other) {
    if (other == null) {
      return new org.gridgain.demo.kafka.model.Account.Builder();
    } else {
      return new org.gridgain.demo.kafka.model.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static org.gridgain.demo.kafka.model.Account.Builder newBuilder(org.gridgain.demo.kafka.model.Account other) {
    if (other == null) {
      return new org.gridgain.demo.kafka.model.Account.Builder();
    } else {
      return new org.gridgain.demo.kafka.model.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.gridgain.demo.kafka.model.Account.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.gridgain.demo.kafka.model.Account other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.gridgain.demo.kafka.model.Account.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.gridgain.demo.kafka.model.Account.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.gridgain.demo.kafka.model.Account.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.gridgain.demo.kafka.model.Account.Builder clearName() {
      name = null;
